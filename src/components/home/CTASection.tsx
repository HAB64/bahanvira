  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden" dir="rtl">
      <div className="container mx-auto px-4">
        <div className="bg-gradient-to-l from-amber-500 via-orange-500 to-teal-600 rounded-[2rem] overflow-hidden relative shadow-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-center relative z-10">
            ...
            <div className="relative h-64 lg:h-full min-h-[300px]">
              ...
              <div className="absolute top-6 right-6 w-8 h-8 bg-white/30 rounded-full backdrop-blur-sm animate-bounce-gentle" />
            ...
            <div className="p-8 md:p-12 text-center lg:text-right">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <a
                  ...
                  className="flex items-center gap-2 bg-white text-amber-700 font-bold px-8 py-4 rounded-2xl hover:bg-gray-100 transition-all shadow-lg hover:scale-105"
                >

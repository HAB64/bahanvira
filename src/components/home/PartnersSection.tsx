...
const partners = [
  {
    ...
    bg: 'bg-gradient-to-br from-[#EF476F]/10 to-[#D6365E]/10 border-pink-100 hover:border-[#EF476F]/60 hover:shadow-purple-900/20',
    emoji: '🧒',
  },
  {
    icon: GraduationCap,
    ...
    bg: 'bg-gradient-to-br from-amber-50 to-orange-50 border-[#FFD166]/40 hover:border-amber-400 hover:shadow-purple-900/20',
    emoji: '🏫',
  },
  {
    icon: BookOpen,
    ...
    bg: 'bg-gradient-to-br from-[#EF476F]/10 to-[#9B59B6]/10 border-[#EF476F]/30 hover:border-teal-400 hover:shadow-teal-100',
    emoji: '📚',
  },
  {
    icon: Building2,
    ...
    bg: 'bg-gradient-to-br from-[#9B59B6]/10 to-[#6C3CE1]/10 border-violet-200 hover:border-violet-400 hover:shadow-violet-100',
    emoji: '🔬',
  },
];
...
export default function PartnersSection() {
  return (
    <section id="partners" className="py-16 md:py-24 relative overflow-hidden" dir="rtl">
      <div className="absolute inset-0 bg-gradient-to-b from-teal-50/30 via-amber-50/20 to-[#9B59B6]" />
      <ChildFriendlyBackground variant="light" />

      <div className="container mx-auto px-4 relative z-10">
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          <span className="inline-flex items-center gap-2 text-[#EF476F] font-bold text-sm mb-3 bg-gradient-to-l from-[#EF476F]/10 to-[#9B59B6]/10 px-5 py-2 rounded-full border border-[#EF476F]/30 shadow-sm">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg text-[#FFFCF9] mb-1">
                      {partner.title}
                    </h3>
                  </div>
                </div>
                <p className="text-sm text-purple-200 leading-7">
                  {partner.description}
                </p>
              </div>
            );
        ...
        <div className="bg-gradient-to-br from-[#6C3CE1]/20 via-[#9B59B6]/30 to-[#6C3CE1]/20 rounded-[2rem] p-8 md:p-12 mb-12 border border-teal-100 shadow-sm relative overflow-hidden">
          <ChildFriendlyBackground variant="light" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            {benefits.map((benefit) => {
              ...
              return (
                <div
                  key={benefit.title}
                  className="bg-[#8B5FC7]/80 backdrop-blur-sm rounded-2xl p-5 border border-white shadow-sm hover:shadow-lg transition-all duration-300 text-center hover:-translate-y-1"
                >
                  <div className="text-2xl mb-2">{benefit.emoji}</div>
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#EF476F]/20 to-[#9B59B6]/20 flex items-center justify-center mx-auto mb-3">
                    <Icon className="w-6 h-6 text-[#EF476F]" />
                  </div>
                  <h4 className="font-bold text-[#FFFCF9] mb-2 text-sm">
                    {benefit.title}
                  </h4>
                  <p className="text-xs text-purple-200 leading-5">
                    {benefit.desc}
                  </p>
                </div>
              );
        ...
        {/* Representative CTA */}
        <div className="bg-gradient-to-l from-[#EF476F] via-[#9B59B6] to-[#6C3CE1] rounded-[2rem] p-8 md:p-12 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                size="lg"
                className="bg-[#7B4FD4] text-[#FFD166] font-bold rounded-2xl px-8 py-6 hover:bg-gray-100 shadow-lg hover:scale-105 transition-all"
                onClick={() => {
              ...
              <a
                ...
                className="flex items-center gap-2 bg-[#7B4FD4]/10 backdrop-blur-sm text-white font-bold px-8 py-4 rounded-2xl hover:bg-[#7B4FD4]/20 transition-all border border-white/30 hover:scale-105"
              >

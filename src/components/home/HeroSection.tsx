    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
          <path d="M0 60L48 55C96 50 192 40 288 45C384 50 480 70 576 75C672 80 768 70 864 60C960 50 1056 40 1152 45C1248 50 1344 70 1392 80L1440 90V120H1392C1344 120 1248 120 1152 120C1056 120 960 120 864 120C768 120 672 120 576 120C480 120 384 120 288 120C192 120 96 120 48 120H0V60Z" fill="#9B59B6" fillOpacity="0.6" />
          <path d="M0 80L48 75C96 70 192 60 288 65C384 70 480 90 576 95C672 100 768 90 864 80C960 70 1056 60 1152 65C1248 70 1344 90 1392 100L1440 110V120H1392C1344 120 1248 120 1152 120C1056 120 960 120 864 120C768 120 672 120 576 120C480 120 384 120 288 120C192 120 96 120 48 120H0V80Z" fill="#9B59B6" />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-6 md:space-y-8 text-center lg:text-right">
            ...
            <div className="inline-flex items-center gap-2 bg-[#7B4FD4]/15 backdrop-blur-md text-white px-5 py-2.5 rounded-full text-sm font-bold border border-white/25 shadow-lg animate-bounce-gentle">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 text-sm">
              <div className="flex items-center gap-1.5 bg-[#7B4FD4]/15 backdrop-blur-sm text-white px-4 py-2 rounded-full border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Button
                size="lg"
                className="bg-gradient-to-l from-[#FFD166] to-[#F0A050] hover:from-amber-400 hover:to-orange-400 text-white rounded-2xl px-8 py-6 text-base font-bold shadow-lg shadow-amber-500/40 hover:shadow-xl hover:shadow-amber-400/50 transition-all hover:scale-105"
                onClick={() => {
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-white/40 text-white hover:bg-[#7B4FD4]/15 backdrop-blur-sm rounded-2xl px-8 py-6 text-base font-bold hover:scale-105 transition-all"
                onClick={() => {
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative w-full max-w-md lg:max-w-lg">
              ...
              <Image
                ...
                width={600}
                height={400}
                className="relative rounded-3xl shadow-2xl shadow-purple-900/30 object-cover border-4 border-white/50"
                priority
              />
            ...
            <div className="absolute bottom-4 right-4 md:bottom-8 md:right-4 bg-[#7B4FD4] rounded-2xl shadow-xl p-3 border border-teal-100 z-10 animate-bounce-gentle" style={{ animationDelay: '0.5s' }}>
              <Image
                src="/logo.webp"
                alt="لوگو ویرا"
                width={52}
